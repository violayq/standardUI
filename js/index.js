...
$(function() {
    ...
    var data = [
        ...
        {id: "3", parentId: "1", title: "查询1", iconClass: "icon-circle", url: "searchResult3.html", orderNum: 1},
        {id: "4", parentId: "2", title: "基本表单", iconClass: "icon-circle", url: "form-single2.html", orderNum: 1},
